            ...
            <div class = "container" style="margin-top:70px;">
                ...
                <ul class="nav nav-pills nav-stacked" style="position: fixed; width: 10%;">
                 ...
                 <div class="col-md-6">
                    ...
                    <div class="well well-lg">
                        <h1>SAUC-E</h1>
                        <p>Held since 2006, SAUC-E challenges the next generation of engineers to design and build an autonomous underwater vehicle (AUV) capable of performing realistic missions.  The event is designed to encourage students to think about underwater technology and related applications while fostering innovation and technology. The event is being organized by  NATO Undersea Research Centre.</p>
